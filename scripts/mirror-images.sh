...
mirror "ghcr.io/benwold-lgtm/open-rag-chat-ui:latest"     "open-rag-chat-ui:latest"
...
echo "    --set image.pullPolicy=IfNotPresent"
echo ""
echo "  chat-ui chart (-n chat-ui):"
echo "    --set image.repository=${REGISTRY}/open-rag-chat-ui"
echo "    --set image.pullPolicy=IfNotPresent"
echo ""
...
echo "    --set image.pullPolicy=IfNotPresent"
echo ""
echo "  vllm-server chart (-n ai-stack):"
